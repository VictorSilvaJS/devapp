...
O contrato vigente para anexos e mapas tecnicos esta em
`modelo-material-tecnico.md`.

## Cadastros Do MVP

O contrato oficial de campos, identidades e vinculos dos cadastros esta em
`modelo-dados-mock-v2.md`. Ele separa Usuario, Produtor, Colaborador,
Administrador, Propriedade, Titular e Vinculo.
