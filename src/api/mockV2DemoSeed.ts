...
import { mergeMockV2DemoQaCoverage } from './mockV2DemoQaCoverage';
 ...
 */
export const MOCK_V2_DEMO_SEED = mergeMockV2DemoQaCoverage(
  generatedSeed as unknown as MockV2State
);
